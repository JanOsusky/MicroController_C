...
#define LED_G_MASK 0x300
#define LED_B_MASK 0x400
...
void PORTB_IRQHandler(void)
{
    ...
    {
        flash1(); /* kazdy vstup do obsluhy preruseni signalizujeme */
        beep(300);
